      ...
      <a-form :form="form" class="two-col-form">
        <div class="flex flex-wrap">
          ...
          <a-form-item label="名称">
            <a-input v-decorator="['explainName',validatorRules.explainName]" placeholder="请输入" />
          </a-form-item>
          <a-form-item label="附件">
            <j-upload v-decorator="['filePath']" />
          </a-form-item>
          <a-form-item label="备注">
            <a-input v-decorator="['remarks']" placeholder="请输入" />
          </a-form-item>
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        explainName: { rules: [{ required: true, message: '请输入名称' }] }
      },
      url: {
        add: '/ywEquipmentManual/ywEquipmentManual/add',
        edit: '/ywEquipmentManual/ywEquipmentManual/edit'
      },
      readOnly: false
    }
  },

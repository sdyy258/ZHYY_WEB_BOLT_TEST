  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="排序" :label-col="labelCol" :wrapper-col="wrapperCol" prop="categorySort">
          <a-input-number v-model="model.categorySort" placeholder="请输入排序" />
        </a-form-model-item>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        categorySort: [{ required: true, message: '请输入排序!' }]
      },
      url: {
  ...
  computed: {
    disabled() {
      return !!this.model.id || this.title === '添加子分类'
    },
    condition() {
      if (this.model.type) {

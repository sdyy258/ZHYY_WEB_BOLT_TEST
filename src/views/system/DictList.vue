<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="12">
          <a-col :md="7" :sm="8">
            <a-form-item label="字典名称" :label-col="{span: 6}" :wrapper-col="{span: 14, offset: 1}">
              <j-input v-model="queryParam.dictName" placeholder="请输入字典名称" />
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8">
            <a-form-item label="字典编号" :label-col="{span: 6}" :wrapper-col="{span: 14, offset: 1}">
              <j-input v-model="queryParam.dictCode" placeholder="请输入字典编号" />
            </a-form-item>
          </a-col>
          <a-col :md="7" :sm="8">
    ...
    <dict-delete-list ref="dictDeleteList" @refresh="() =>loadData()" />
  </a-card>
</template>
